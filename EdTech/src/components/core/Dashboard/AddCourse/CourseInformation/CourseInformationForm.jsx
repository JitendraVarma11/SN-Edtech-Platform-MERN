      ...
      <div className="flex flex-col space-y-2">
        ...
        <div className="relative">
          <input
            ...
            className="px-[50px] w-full rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5 border-b-[0.5px] border-richblack-100"
          />
      ...
      <div className="flex justify-end gap-x-2">
        {editCourse && (
          <button
            ...
            disabled={loading}
            className={`flex cursor-pointer items-center gap-x-2 rounded-md bg-richblack-300 md:py-[8px] font-semibold text-richblack-900`}
          >
